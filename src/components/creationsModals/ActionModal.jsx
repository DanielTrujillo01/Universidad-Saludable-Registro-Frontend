      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* 1. PRIORIDAD (Select Normal - Pocos datos) */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Prioridad
              </label>
            ...
            {/* 2. LÍNEA DE ESTRATEGIA (Select Normal - Pocos datos) */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Línea de Estrategia
              </label>
              ...
              >
                <option value="">Seleccione una línea de estrategia</option>
            ...
            {/* 3. ESTRATEGIA (Select Normal - Pocos datos) */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Estrategia
              </label>
          ...
          >
            {loading ? "Guardando..." : "Guardar Accion"}
          </button>
        </form>
        ...
        {success && (
          <div className="flex items-center gap-2 text-green-700 bg-green-50 border border-green-200 rounded-lg px-3 py-2 text-sm font-medium animate-pulse">
            ...
            Accion creada y vinculada con éxito
          </div>
        )}
      </div>
    </div>
